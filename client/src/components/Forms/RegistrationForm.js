    ...
    <>
      <div className="mx-auto mb-20 p-3">
        ...
        <div className="flex sm:w-8/12 mt-7">
          ...
          <div className="ms-6 w-1/2">
            <p className="mb-3 text-sm text-gray-300">Occupation</p>{" "}
            {/* corrected typo here */}
            <div className="bg-[#1A1D21] rounded-lg border  border-gray-600">
              <input
                className="py-3 px-2 w-full bg-transparent outline-none"
        ...
        <div>
          ...
          <div className="mt-5">
            <label>
              <input type="checkbox" className="bg-red-500 me-4" />I consent to
              receive treatment for my health condition.
            </label>
          </div>
          <div className="mt-5">
            <label>
              <input type="checkbox" className="bg-red-500 me-4" />I consent to
              the use and disclosure of my health information for treatment
              purposes.
            </label>
          </div>
          <p className="mt-5">
